...
//   return (
//     <header className="sticky to-0 z-50 bg-white/90 backdrop-blur-md shadow-sm border-b border-gray-200 font-sans">
...
//         >
//           {/* {logo} */}
//           <div className="relative w-10 h-10 flex items-center justify-center rounded-xl bg-gradient-to-tr from-fuchsia-500 via-purple-500 to-indigo-500 shadow-lg group-hover:shadow-purple-300/50 group-hover:scale-105 transition-all duration-300">
...
//           <button
//             className="p-2 text-gray-500 hover:text-purple-500 transition-colors duration-300 hover:bg-purple-50 rounded-full"
...
//                     src={User.avatar}
//                     alt="Avatar"
//                     className="w-9 h-9 rounded-r-full shadow-sm"
//                   />
//                 ) : (
...
//                 <p className="tex-sm font-medium text-gray-800">{User.name}</p>
//                 <p className="tex-xs font-normal text-gray-500">{User.email}</p>
//               </div>
//               <ChevronDown
    ...
    <header className="sticky top-0 z-50 bg-white/90 backdrop-blur-md shadow-sm border-b border-gray-200 font-sans">
      <div className="flex items-center justify-between px-4 py-3 md:px-6 max-w-7xl mx-auto">
        ...
        <div
          ...
          onClick={() => navigate("/")}
        >
          <div className="relative w-10 h-10 flex items-center justify-center rounded-xl bg-gradient-to-tr from-fuchsia-500 via-purple-500 to-indigo-500 shadow-lg group-hover:scale-105 transition-all duration-300">
            <Zap className="w-6 h-6 text-white" />
          </div>
          <span className="text-2xl font-extrabold bg-gradient-to-r from-fuchsia-500 via-purple-500 to-indigo-500 bg-clip-text text-transparent tracking-wide">
            Taskflow
        ...
        <div className="flex items-center gap-4">
          ...
          <div ref={menuref} className="relative">
            ...
            {menuOpen && (
              <ul className="absolute top-14 right-0 w-56 bg-white rounded-2xl shadow-xl border border-purple-100 z-50 overflow-hidden">
                <li className="p-2">
                  <button
                    onClick={() => {
                      setMenuOpen(false);
