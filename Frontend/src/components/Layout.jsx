...
const Layout = ({ onLogout, user }) => {
  ...
  const StatCard = ({ title, value, icon }) => (
    <div className="p2 sm:p-3 rounded-xl bg-white shadow-sm border border-purple-100 hover:shadow-md transition-all duration-300 hover:border-purple-100 group">
    ...
    return (
      <div className="min-h-screen bg-gray-50 p-6 flex items-center justify-center">
        <div className="bg-red-50 text-red-600 p-4 rounded-xl border border-red-100 max-w-md">
          ...
          <button
            onClick={fetchTasks}
            className="mt-4 py-3 px-4 bg-red-100 text-red-700 rounded-lg text-sm font-medium hover:bg-red-200 transition-colors"
          >
            Try Again
          </button>
        </div>
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="ml-0 xl:ml-64 lg:ml-64 md:ml-16 pt-16 p-3 sm:p-4 md:p-4 transition-all duration-300">
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-4 sm:gap-6">
          ...
          <div className="xl:col-span-1 space-y-4 sm:space-y-4">
            <div className="bg-white rounded-xl p-4 sm:p-5 shadow-sm border border-purple-100">
              <h3 className="text-base sm:text-lg font-semibold mb-3 sm:mb-4 to-gray-800 flex items-center gap-2">
                <TrendingUp className="h-5 w-5 sm:w-5 sm:h-5 text-purple-500" />
                Task Statistics
              </h3>
              ...
              <div className="space-y-2 sm:space-y-3">
                <div className="flex items-center justify-between text-gray-700">
                  <span className="text-xs sm:text-sm font-medium flex items-center gap-15">
                ...
                <div className="relative pt-1">
                  <div className="flex gap-1.5 items-center">
                    <div className="flex-1 h-2 sm:h3 bg-purple-100 rounded-full           overflow-hidden">
                      <div
            ...
            <div className="bg-white rounded-xl p-4 sm:p-5 shadow-sm border border-purple-100">
              <h3 className="text-base sm:text-lg font-semibold mb-3 sm:mb-4 text-gray-800 flex items-center gap-2">
                {" "}
                <Clock className="w-4 h-4 sm:w-5 sm:h-5 text-purple-50" />
                Recent Activity
              </h3>
              <div className="space-y-2 sm:space-y-3">
