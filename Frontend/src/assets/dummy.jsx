...
export const CT_CLASSES = {
  ...
  sortContainer: "w-full md:w-auto mt-2 md:mt-0 flex-shrink-0", // Added flex-shrink-0
  sortBox:
    "flex items-center justify-between bg-white p-2 md:p-2 rounded-xl shadow-sm border border-purple-100 w-full md:w-auto",
};
